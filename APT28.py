...
# Compile the rules
rules = yara.compile(source=rules_definition)
...
#test_string = 'your_test_string'  # Replace with a string to test
#print("Scanning string:", test_string)
#print(scan_string(test_string))
